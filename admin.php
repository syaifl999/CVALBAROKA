...
<body>
  <div class="form-container">
    ...
    <form action="tambah_artikel.php" method="post" enctype="multipart/form-data">
      ...
      <a href="index.php" class="btn btn-danger ml-2" style="background-color: #007bff; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;">Logout</a>
    </form>
  </div>
</body>
</html>
